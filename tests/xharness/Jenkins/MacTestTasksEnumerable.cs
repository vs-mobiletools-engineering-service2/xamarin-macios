			...
			foreach (var project in jenkins.Harness.MacTestProjects) {
				...
				foreach (var config in configurations) {
					...
					if (project.IsDotNetProject) {
						build = new DotNetBuildTask (jenkins: jenkins, testProject: project, processManager: processManager);
					} else {
						build = new MSBuildTask (jenkins: jenkins, testProject: project, processManager: processManager);
					}
